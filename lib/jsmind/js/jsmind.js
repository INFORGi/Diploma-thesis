    ...
    createNode(data, parent) {
        ...
        if (parent) {
            ...
            if (parentNode && parentNode.element.nodeData) {
                // Наследуем стили узла
                data.style = {
                    ...parentNode.element.nodeData.nodeStyle,
                    ...(data.style || {})
                };
                
                // Наследуем стили текста, включая выравнивание
                data.topicStyle = {
                    ...parentNode.element.nodeData.topicStyle,
                    textAlign: parentNode.element.nodeData.topicStyle?.textAlign || 'center',
                    verticalAlign: parentNode.element.nodeData.topicStyle?.verticalAlign || 'center',
                    ...(data.topicStyle || {})
                };
            }
        }
