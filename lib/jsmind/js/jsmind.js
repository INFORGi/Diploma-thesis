...
export class jsMind {
    ...
    createNode(data, parent) {
        ...
        if (parent) {
            ...
            if (parentNode && parentNode.element.nodeData && parentNode.element.nodeData.style) {
                data.style = { ...parentNode.element.nodeData.style, ...data.style };
            }
        }
        ...
        Object.assign(node.style, node.nodeData.style);
