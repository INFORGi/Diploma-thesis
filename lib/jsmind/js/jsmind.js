import { FIGURE, TOPIC_STYLES, NODE_STYLES, LINE_STYLES, DEFAULT_NODE_DATA } from '../../../data/constants.js';
...
export class jsMind {
    ...
    makeNodeDraggable(node) {
        ...
        const onMouseDown = (e) => {
            ...
            this.setActiveNode(node);
            this.options.onNodeAddButtonActive(node.id); // Показываем кнопку при нажатии
